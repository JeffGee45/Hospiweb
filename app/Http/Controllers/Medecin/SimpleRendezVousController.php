...
class SimpleRendezVousController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('medecin.rendez-vous.simple-index', compact('rendezVous'));
    }
    ...
    public function show($id)
    {
        ...
        return view('medecin.rendez-vous.simple-show', compact('rendezVous'));
    }
