            ...
            <aside class="w-64 bg-white shadow-md min-h-screen flex flex-col justify-between">
                <div>
                    <div class="p-4 border-b">
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                            ...
                            <h1 class="text-xl font-bold text-gray-800">Hospiweb</h1>
                        </a>
                    </div>
                    <nav class="mt-4">
                ...
                <div class="p-4 border-t">
                    <div class="flex items-center gap-3 mb-3">
                         <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10"
                                style='background-image: url("https://lh3.googleusercontent.com/a/ACg8ocJ-92yI_iWk5qKx_Y5S...=s96-c");'> {{-- Placeholder --}}
                         </div>
                        <div>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="w-full flex items-center gap-3 px-4 py-2 text-left text-sm text-red-600 hover:bg-red-100 rounded-lg transition-colors duration-200">
