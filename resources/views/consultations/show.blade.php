...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('patients.consultations.index', $consultation->patient_id) }}" class="text-blue-500 hover:text-blue-700 font-semibold">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Dr. {{ $consultation->medecin->prenom }} {{ $consultation->medecin->nom }} ({{ $consultation->medecin->specialite }})</p>
            </div>
            <div>
                <h3 class="text-lg font-semibold text-gray-700">Date de la consultation</h3>
                <p class="text-gray-600">{{ \Carbon\Carbon::parse($consultation->date_consultation)->format('d/m/Y') }}</p>
            </div>
        </div>
        ...
        <div>
            ...
            @if ($consultation->prescription)
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <p class="mb-4"><strong>Date de prescription :</strong> {{ \Carbon\Carbon::parse($prescription->date_prescription)->format('d/m/Y') }}</p>
            ...
            @else
                <div class="text-center py-6 px-4 border-2 border-dashed border-gray-300 rounded-lg">
                    ...
                    <a href="{{ route('consultations.prescriptions.create', $consultation) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
