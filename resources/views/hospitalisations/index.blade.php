...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <a href="{{ route('patients.hospitalisations.create', $patient) }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6m-6 0v6m0 0H7a2 2 0 01-2-2v-5a2 2 0 012-2h3" />
                    </svg>
                            ...
                            @foreach ($hospitalisations as $hospitalisation)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        {{ \Carbon\Carbon::parse($hospitalisation->date_entree)->format('d/m/Y') }}</td>
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        {{ $hospitalisation->date_sortie ? \Carbon\Carbon::parse($hospitalisation->date_sortie)->format('d/m/Y') : 'En cours' }}
                                    </td>
