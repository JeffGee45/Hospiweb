...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6 text-center">
            <h1 class="text-3xl font-bold text-gray-800 mb-4">Bienvenue sur Hospiweb</h1>
            ...
            <h2 class="text-2xl font-semibold text-gray-700 mb-2">Bonjour, {{ $user->name }} !</h2>
            <p class="text-gray-600 mb-6">Bienvenue sur votre tableau de bord Hospiweb.</p>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Votre compte est actif. Pour plus d'options, veuillez contacter l'administrateur.
                        </p>
                    </div>
                </div>
            </div>
