...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('rendez-vous.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
            Nouveau Rendez-vous
        </a>
    </div>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                @forelse ($rendezVous as $rdv)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap">{{ $rdv->date_rendez_vous->format('d/m/Y à H:i') }}</td>
                        ...
                        <td class="py-3 px-6 text-center">
                            <span class="bg-blue-200 text-blue-600 py-1 px-3 rounded-full text-xs">{{ $rdv->statut }}</span>
                        </td>
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="{{ route('rendez-vous.edit', $rdv->id) }}" class="w-6 mr-2 transform hover:text-purple-500 hover:scale-110">
