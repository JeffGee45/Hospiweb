    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mt-10 bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.rapports.export.consultations') }}"
                    ...
                    Export PDF - Consultations / Médecin
                </a>
                <a href="{{ route('admin.rapports.export.hospitalisations') }}"
                    ...
                    Export PDF - Hospitalisations
                </a>
                <a href="{{ route('admin.rapports.export.medicaments') }}"
                    ...
                    Export PDF - Médicaments
                </a>
                <a href="{{ route('admin.rapports.export.statistiques') }}"
